                      ...
                      : FutureBuilder(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot == null || snapshot.hasError) {
                              ...
                              var episodeNumber = listdata.episodesNo;
                              var episodepage = listdata.episodesLink;
                              return Container(
                                child: Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(10, 250, 10, 5),
                                  child: Column(
                                    mainAxisAlignment:
  ...
  void _insertWatching(key, listdata, String cover, String url) async {
    try {
      Map<String, dynamic> row = {
        ...
        _databaseHelper.category: listdata.tags,
