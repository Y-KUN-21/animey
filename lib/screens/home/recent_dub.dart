...
import 'package:anime/screens/home/view_recent_dub.dart';

class RecentDubAnimes extends StatefulWidget {
  @override
  _RecentDubAnimesState createState() => _RecentDubAnimesState();
}

ApiRepository _apiRepository = ApiRepository();

class _RecentDubAnimesState extends State<RecentDubAnimes> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: _apiRepository.getRecentDubbed,
        builder: (BuildContext context,
            AsyncSnapshot<List<RecentDubbedModel>> snapshot) {
