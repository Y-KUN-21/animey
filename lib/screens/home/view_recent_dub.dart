...
class ViewAllRecentDub extends StatefulWidget {
  final List recentList;
  ViewAllRecentDub({this.recentList});
  @override
  _ViewAllRecentDubState createState() => _ViewAllRecentDubState();
}

class _ViewAllRecentDubState extends State<ViewAllRecentDub> {
  @override
